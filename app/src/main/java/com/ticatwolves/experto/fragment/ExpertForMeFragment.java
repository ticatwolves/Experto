 ...
 * Use the {@link ExpertForMeFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ExpertForMeFragment extends Fragment {
     ...
     * @return A new instance of fragment ExpertForMeFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ExpertForMeFragment newInstance(String param1, String param2) {
        ExpertForMeFragment fragment = new ExpertForMeFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_expert_for_me, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        queryRecyclerView = (RecyclerView)getActivity().findViewById(R.id.expert_recycler_view);
        ...
        final String id = user.get(SessionManager.KEY_UID);
        Log.e("heybro",id);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    for (DataSnapshot d : postSnapshot.child(id).getChildren()){
                        AddProblem problems = d.getValue(AddProblem.class);
                        url.add(postSnapshot.getKey()+" "+id+" "+d.getKey()+"");
                        try{
